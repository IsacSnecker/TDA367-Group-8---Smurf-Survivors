    ...
    public void buttonsInit() {
        ...
        this.view.settingsMenu.musicVolumeSlider.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                view.getAudioManager().setMusicVolume(view.settingsMenu.musicVolumeSlider.getValue()/100);
            }
        });
        this.view.settingsMenu.soundVolumeSlider.addListener(new ChangeListener() {
            @Override
            public void changed(ChangeEvent event, Actor actor) {
                view.getAudioManager().setSoundVolume(view.settingsMenu.musicVolumeSlider.getValue()/100);
            }
        });
