...
public abstract class ActiveWeapon extends AbstractWeapon{
    public ActiveWeapon(Vector2 _position, Texture _weaponTexture, float _width, float _height, float _attackRange, int _velocity, int _attackDamage, String _weaponName){
